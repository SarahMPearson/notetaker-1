...
var Hapi         = require('hapi'),
  server         = new Hapi.Server('0.0.0.0', process.env.PORT, {cors:{
                                                                        origin: ['http://localhost:8100'], credentials: true}, timeout:{client:60000}}), //cors:true is telling hapi it is okay if someone talks to you from a different domain you then have to go to the client side in their app.js $httpProvier.defaults = true * something
